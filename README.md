...
TXT _dmarc.nymann.dev "v=DMARC1; p=none; rua=mailto:dmarc.report@nymann.dev; ruf=mailto:dmarc.report@nymann.dev; sp=none; ri=86400"
TXT mail._domainkey.nymann.dev (set to the value of mailserver/data/dms/config/opendkim/keys/nymann.dev/mail.txt (one line))
